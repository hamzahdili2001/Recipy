<template>
  <v-card
    class="w-100 d-flex justify-center align-center bg-grey-lighten-5 flex-column pa-10"
    rounded="0"
    flat
  >
    ...
    <div class="mt-4 d-flex justify-center align-center ga-4">
      <v-btn flat elevation="1" min-width="100px" to="/profile/bookmarks"
        >Bookmarks</v-btn
      >
      <v-btn flat elevation="1" min-width="100px" to="/profile/posts"
        >Your Posts</v-btn
      >
      <input type="file" @change="handleFileUpload" accept="image/*" />
      <!-- File input for uploading picture -->
      <v-btn class="bg-red-accent-2" flat elevation="1" min-width="100px"
